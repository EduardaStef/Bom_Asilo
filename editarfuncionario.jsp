        ...
        %>
                    ...
                    <form action="recebeeditafuncionario.jsp" method="POST">
                        ...
                        <input type="text" name="nome" 
                                value="<%out.write(f.getNome());%>" /><br />
                        
                        <label>CPF</label>
                        <input type="text" name="cpfFuncionario" 
                               value="<%out.write(f.getCpfFuncionario());%>" /><br />
                        
                        <label>RG</label>
                        <input type="text" name="rg" 
                               value="<%out.write(f.getRg());%>" /><br />
                        ...
                        <input type="text" name="regProfissional" 
                               value="<%out.write(f.getRegProfissional());%>" /><br />
                        
                        <label>Data de Admissão</label>
                        <input type="date" name="dataAdmissao" 
                               value="<%out.write(""+f.getDataAdmissao());%>" /><br />
                        
                        <label>Data de Desligamento</label>
                        <input type="date" name="dataDesliga" 
                                value="<%if (f.getDataDesliga() != null){out.write(""+f.getDataDesliga());}%>" /><br />
                        
                        <label>E-mail</label>
                        <input type="text" name="emailFuncionario" 
                               value="<%out.write(f.getEmailFuncionario());%>" /><br />
                        ...
                        <input type="hidden" name="idFuncionario" 
                               value="<%out.write(""+f.getIdFuncionario());%>" /><br /><hr />
